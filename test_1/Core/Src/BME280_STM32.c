...
{
	uint8_t trimdata[24];
	// Read NVM from 0x88 to 0x9F
	HAL_I2C_Mem_Read(BME280_I2C, BME280_ADDRESS, 0x88, 1, trimdata, 24, HAL_MAX_DELAY);
...
/************* COMPENSATION CALCULATION AS PER DATASHEET (page 22) **************************/
